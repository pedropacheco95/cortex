...
Agent tool call:
  prompt: "You have the specflow-onboard-codebase skill. Run the full 8-phase onboarding
           ...
           bugs.md, proposed-notes.md, onboarding-scratch/atoms/ — to
...
# Compare bug lists
diff onboarding-scratch/pass-a/bugs.md onboarding-scratch/pass-b/bugs.md
...
same domain folders, same bug flagged in all 3 bugs.md files. These go directly into the
final output without further investigation.
...
4. **Merge bugs.md** — include only bugs that are either convergent (all passes agree) or
   confirmed by investigation. Do not include dismissed bugs.
