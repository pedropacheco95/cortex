...
3. `anatomy/` — the native code-structure scanner and its artefacts (`files.md`, `graph.json`, `layers.md`).
4. `cerebrum/` — the write-time enforcement layer plus the unified bug ledger, rules, preferences, environment, and decisions.
