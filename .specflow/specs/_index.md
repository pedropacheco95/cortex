...
- `schema.id-registry` → `schema.validator`, `core-cli.sync`, `pulse.threads`, `pulse.review-cli` (the writers it amends are implemented; the edge points from the draft to them)
- `schema.visibility` → `schema.validator`, `core-cli.init`
- `compass.bug-currency` → `schema.validator`, `pulse.threads`, `schema.id-registry`
...
7. Wave follow-up B (approved 2026-09-17; schema 3.4 fifth revision in place; `plans/2026-09-17-wave-b.md`; source: the parallel-wave brief, `.cortex/archive/documents/parallel-wave-brief-2026-09-14/`): `schema.id-registry`, `schema.visibility`, `compass.bug-currency` — specified, draft; amended in place: `recall.recall-index` Rules 1, 8, 13, 15–17 (compass carriers), `hooks.search-annotate` Rules 7–8, `hooks.pre-read-writeback` Rule 6 (`Bugs:` part), `recall.why` Rules 1, 4, 5, `pulse.usage` Rule 11, `pulse.threads` Rule 12, `pulse.review-cli` Rules 7/7b, `core-cli.init` Rules 3, 10, `core-cli.sync` Rules 3, 10, 15, `archive.ingest-skill` Entities; schema §4.1/§4.2/§4.11/§8/§10.1/§10.4/Appendix A; RULES.md rule 20
